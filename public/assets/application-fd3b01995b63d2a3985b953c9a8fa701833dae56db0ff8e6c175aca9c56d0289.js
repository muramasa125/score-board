...
function addStats(player,statsDetail) {
	if (statsDetail === "ace") {
		aces[player - 1] ++;
		winner[player - 1] ++;
		totalPoint[player - 1] ++;
	}
	if (statsDetail === "netPoint") {
		netPointWon[player - 1] ++;
		winner[player - 1] ++;
		totalPoint[player - 1] ++;
	}
	if (statsDetail === "otherPoint") {
		winner[player - 1] ++;
		totalPoint[player - 1] ++;
	}
...
function checkFault(uncheckOnly){
	if (!uncheckOnly) {
		if ($(".fault-button").hasClass("btn-warning")) {
			fault = true;
			$(".fault-button").removeClass("btn-warning");
			$(".fault-button").addClass("btn-danger");
			return;
		}
	}
	
	if ($(".fault-button").hasClass("btn-danger")) {
		fault = false;
		$(".fault-button").removeClass("btn-danger");
		$(".fault-button").addClass("btn-warning");
		return;
	}
}
...
$(document).ready(function() {
	...
	$(".winner-button").click(function(e) {
		...
		var player;
		var player1Button = $(this).parents("div").hasClass("player1-button");
		if (player1Button) {
			player = player1;
		} else {
			player = player2;
	...
	$(".netpoint-button").click(function(e) {
		if (win != 0) {
			return false;
		}
		...
		addStats(player,"netPoint");
		showScore();
	});

	$(".otherpoint-button").click(function(e) {
		if (win != 0) {
			return false;
		}
	...
	$(".doublefault-button").click(function(e) {
		if (win != 0) {
			return false;
		}
		...
		addStats(player,"doubleFault");
		showScore();
	});

	$(".unferror-button").click(function(e) {
		if (win != 0) {
			return false;
		}
		...
		addStats(player,"unfError");
		showScore();
	});

	$(".ferror-button").click(function(e) {
		if (win != 0) {
			return false;
		}
